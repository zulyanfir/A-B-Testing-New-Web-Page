...
<div style="margin-top:20px;">
  ...
  <ul>
    ...
    <li>Confidence Interval berada di antara `−0,0214 hingga 0,0235`, artinya kita yakin 95% bahwa halaman baru akan menarik pengguna untuk membeli produk perusahaan antara −0,02% hingga 0,02% dibandingkan halaman lama.</li>
  </ul>
</div>

Maka, berdasarkan hasil yang didapatkan, perusahaan sebaiknya tidak menggunakan halaman baru.
